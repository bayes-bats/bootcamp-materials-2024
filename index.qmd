...
<!-- Federica will also be holding office hours and you will receive the appropriate zoom links via email from her. -->

<!-- ## Day 0 - Introduction to the Toolkit -->

<!-- Videos to be watched before the bootcamp. If you run into any issues about this content please let us know in advance. <!--Federica will hold office hours on XXX. You can join the office hours using the zoom link.--> 
<!-- You can also feel free to ask questions on the #bootcamp channel on Slack. --> 
